...
public class DashedDrawing {
    ...
    {
        drawDashedRectangle(gc,vec1,vec2,Color.BLACK);
    }
    public static void drawDashedRectangle(GraphicsContext gc, Vector2F vec1,Vector2F vec2, Color color)
    {
        float x1=vec1.getX();
        float y1=vec1.getY();
        float x2=vec2.getX();
        ...
        drawDashedLine(gc, vec1, vec2,color);
